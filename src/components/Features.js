...
const Features = () => {
  return (
    ...
    <div className='divcont1' style={{ width: '100%', height: '600px', padding: '200px', margin: '0 25%' }}>
    ...
    <div className='divcont1' style={{ width: '2500px', height: '600px', padding: '200px', margin: '0 25%' }}>
